...
def generate_and_save_image(prompt:str, reference_image:str, output_filename:str):
    """
    이미지를 생성하고 저장하는 함수
    ...
    try: # 클라이언트 초기화
        ...
        if reference_image:
            ...
            result = client.models.generate_images(
                model='imagen-3.0-generate-002', # 이메진4 모델 결제해야하는듯.
                prompt=prompt,
                config=dict(
